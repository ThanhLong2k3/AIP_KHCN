...
exports.deleteAdvisoryMember = void 0;
...
const deleteAdvisoryMember = async (req, res) => {
    try {
        ...
        const result = await (0, advisory_member_service_1.deleteAdvisoryMemberService)(id, deleted_by);
