...
exports.addBlogViewService = exports.getBlogAuthorsService = exports.deleteBlogService = exports.searchBlogService = exports.updateBlogService = exports.createBlogService = void 0;
...
const addBlogViewService = async (blogId) => {
    try {
        if (!blogId?.trim())
            throw new Error('id bài viết không được để trống');
        await (0, blog_repository_1.addBlogView)(blogId);
    }
    catch (error) {
        throw new Error('Không thể thêm lượt xem cho bài viết' + error);
    }
};
exports.addBlogViewService = addBlogViewService;
