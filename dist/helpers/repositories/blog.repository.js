...
exports.addBlogView = exports.getBlogAuthors = exports.searchBlogs = exports.deleteBlog = exports.updateBlog = exports.createBlog = void 0;
...
const addBlogView = async (blogId) => {
    try {
        const sql = 'CALL add_blog_view(?)';
        await (0, api_Provider_1.db_Provider)(sql, [blogId], true);
    }
    catch (error) {
        throw new Error(error.message);
    }
