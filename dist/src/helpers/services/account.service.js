...
const verifyCurrentPasswordService = async (username, currentEncryptedPassword) => {
    try {
        ...
        const decryptedPassword = (0, access_1.decrypt)(currentEncryptedPassword);
        if (!decryptedPassword)
            throw new Error("Mật khẩu không hợp lệ.");
...
const updateProfileService = async (username, model) => {
    try {
        ...
        if (model.newPassword) {
            ...
            const decryptedCurrentPassword = (0, access_1.decrypt)(model.currentPassword);
            ...
            const decryptedNewPassword = (0, access_1.decrypt)(model.newPassword);
